...
m:nmap():k('z='):c(':setlocal spell<CR>z=')
...
m:group(
  ...
  m:nnoremap():desc('line downwards'):k('<C-M-j>'):c([["dY"dp]])
  m:nnoremap():desc('line upwards'):k('<C-M-k>'):c([["dY"dP]])
  m:vnoremap():desc('selection downwards'):k('<C-M-j>'):c([["dy`<"dPjgv]])
  m:vnoremap():desc('selection upwards'):k('<C-M-k>'):c([["dy`>"dpgv]])
end
)
