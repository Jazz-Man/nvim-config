...
util.nmap('<leader>xx', '<cmd>Trouble<cr>')
util.nmap('<leader>xw', '<cmd>Trouble workspace_diagnostics<cr>')
util.nmap('<leader>xd', '<cmd>Trouble document_diagnostics<cr>')
util.nmap('<leader>xl', '<cmd>Trouble loclist<cr>')
util.nmap('<leader>xq', '<cmd>Trouble quickfix<cr>')
util.nmap('gR', '<cmd>Trouble lsp_references<cr>')
