...
local function resolve_config(server_config)
  ...
  if server_config.flags then
    ...
    defaults.flags = vim.tbl_deep_extend("force", defaults.flags, server_config.flags or {})

  end

  if server_config.capabilities then

    defaults.capabilities = vim.tbl_deep_extend("force", defaults.capabilities, server_config.capabilities or {})
  end
